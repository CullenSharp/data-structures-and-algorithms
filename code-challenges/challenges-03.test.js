...
const addTwo = arr => arr.map(value => value+2);
...
const getStatName = (arr, minBaseStat) => getBaseStatGreaterThan(arr, minBaseStat).map(value => value.stat.name);
